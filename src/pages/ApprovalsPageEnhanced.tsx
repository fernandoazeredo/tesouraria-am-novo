...
export function ApprovalsPageEnhanced() {
  ...
  return <>
    <div className="page-heading"><div><span className="eyebrow">Fluxo de aprovação</span><h1>Aprovações</h1><p>Todos os colaboradores ativos podem acompanhar a fila. Ana Paula Müller é a única autorizadora oficial de pagamentos; o Administrador Master Fernando possui as mesmas ações para testes e homologação do sistema.</p></div></div>
