...
function generatePaymentPdf(kind: PaymentKind, sources: AnyRecord[], planMap: Map<string, AnyRecord>) {
  ...
  openPdfPrint(title, `<div class="company">TESOURARIA AM NOVO</div><h1>${escapeHtml(title)}</h1><div class="subtitle">Controle financeiro por pagamento efetivo</div>${sections}`)
}
